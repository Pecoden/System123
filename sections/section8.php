                                ...
                                <div class="rtl u-align-right u-form u-form-1">
                                    <form action="https://forms.nicepagesrv.com/v2/form/process"
                                        ...
                                        <div class="u-form-email u-form-group u-label-none">
                                            ...
                                            <input type="email" placeholder="ابحث عن الغرض" id="email-db12"
                                                name="search"
                                        ...
                                        <tbody class="u-align-center u-table-body">
                                            <tr style="height: 65px;">
                                                ...
                                                <td
                                                    ...
                                                    كرسي</td>
                                                <td
                                                    class="u-align-center u-border-2 u-border-grey-10 u-border-no-left u-border-no-right u-palette-1-base u-table-cell u-table-cell-8">
                                                    4356</td>
                                            </tr>
                                            <tr style="height: 65px;">
                                                <td
                                                ...
                                                <td
                                                    ...
                                                    كمبيوتر</td>
                                                <td
                                                    class="u-align-center u-border-2 u-border-grey-10 u-border-no-left u-border-no-right u-palette-1-base u-table-cell u-table-cell-12">
                                                    3462</td>
                                            </tr>
                                            <tr style="height: 65px;">
                                                <td
                                                ...
                                                <td
                                                    ...
                                                    غلاف</td>
                                                <td
                                                    class="u-align-center u-border-2 u-border-grey-10 u-border-no-left u-border-no-right u-palette-1-base u-table-cell u-table-cell-16">
                                                    2523</td>
                                            </tr>
                                            <tr style="height: 65px;">
                                                <td
                        ...
                        <div class="u-expanded-width u-list u-list-1">
                            <div class="u-repeater u-repeater-1">
                                ...
                                <div onclick="show_sec4()"
                                    class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-palette-1-base u-container-align-right u-container-style u-custom-item u-hover-feature u-list-item u-repeater-item u-white u-list-item-4">
